...
REST API для Федерации Спортивного Туризма России (ФСТР). Система предназначена для сбора и управления данными о перевалах, которые пользователи проходят во время походов.
